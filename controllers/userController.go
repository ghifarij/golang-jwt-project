...
import (
	...
	"github.com/ghifarij/golang-jwt-project/database"
	helper "github.com/ghifarij/golang-jwt-project/helpers"
	"github.com/ghifarij/golang-jwt-project/models"
...
func VerifyPassword(userPassword string, providedPassword string) (bool, string) {
	...
	if err != nil {
		fmt.Sprintf("email or password is incorrect")
		check = false
	}
